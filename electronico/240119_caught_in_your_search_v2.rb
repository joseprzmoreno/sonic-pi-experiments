use_bpm 70
rs = 12 #15 150 180 190 12
ornams = 0
hey = '/home/jose/projects/sonic-pi-experiments/samples/hey.wav'
...
live_loop :mel, sync: :drums do
  sample hey, amp: 6, rate: 1.1
  sample hey, amp: 6, rate: 1.15
  sample hey, amp: 6, rate: 1.2
  use_random_seed rs
  use_synth :pluck
